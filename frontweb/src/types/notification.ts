export enum NotificationType {
  ...
  PROJETO_PRAZO_ALTERADO = 'PROJETO_PRAZO_ALTERADO',
  PROJETO_PRAZO_PROXIMO = 'PROJETO_PRAZO_PROXIMO',
  PROJETO_CONCLUIDO = 'PROJETO_CONCLUIDO',
  PROJETO_REMOVIDO = 'PROJETO_REMOVIDO',
  PROPOSTA_ATUALIZADA = 'PROPOSTA_ATUALIZADA',
  SUBTAREFA_ATRIBUIDA = 'SUBTAREFA_ATRIBUIDA',
  SUBTAREFA_CONCLUIDA = 'SUBTAREFA_CONCLUIDA',
  TAREFA_RECORRENTE_CRIADA = 'TAREFA_RECORRENTE_CRIADA',
}
